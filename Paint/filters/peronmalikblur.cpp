...
PeronaMalikBlur::PeronaMalikBlur(): AFilter("Perona Malik Blur")
{
    params.append({blurLevelName , DOUBLE, 0,1000,10});
    params.append({ deltaName, DOUBLE, 0.01,10,0.2});
    params.append({ coefficientName, DOUBLE, 1,100,10});
}
/**

...
RGBAFilter::RGBAFilter(): AFilter("RGBA")
{
    params.append({ deltaRedName, INT, -255,255,0});
    params.append({ deltaGreenName, INT, -255,255,0});
    params.append({ deltaBlueName, INT, -255,255,0});
    params.append({ deltaAlphaName, INT, -255,255,0});
